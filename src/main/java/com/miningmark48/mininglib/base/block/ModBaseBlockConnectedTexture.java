...
public class ModBaseBlockConnectedTexture extends ModBaseBlock{
     ...
     **/
    public ModBaseBlockConnectedTexture(Material material, MapColor color, float blockHardness, float blockResistance) {
