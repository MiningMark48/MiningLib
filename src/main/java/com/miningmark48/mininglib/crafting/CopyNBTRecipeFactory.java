package com.miningmark48.mininglib.crafting;
...
public class CopyNBTRecipeFactory implements IRecipeFactory{
    ...
    public IRecipe parse(JsonContext context, JsonObject json) {
        ...
        return new CopyNBTRecipe(new ResourceLocation(MiningLib.MOD_ID, "copy_nbt_crafting"), recipe.getRecipeOutput(), primer);
    }
